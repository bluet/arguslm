...
const MonitoringPage: React.FC = () => {
  ...
  const handleEnableAll = async (providerId: string, enable: boolean) => {
    ...
    try {
      ...
      const modelsData = await modelsApi.listAllModels();
      setModels(modelsData);
    }
  };
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8 transition-colors duration-200">
      ...
      <section className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Global Settings</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className={`text-sm font-medium ${formConfig.enabled ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400'}`}>
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Prompt Pack</label>
            <select
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={running}
              className="flex-1 flex items-center justify-center gap-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-md hover:bg-gray-200 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 transition-colors"
            >
      ...
      <section className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Model Selection</h2>
          </div>
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-end gap-2 mb-4">
                ...
                <button
                  ...
                  className="text-xs font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300"
                >
                  Disable All
                </button>
              </div>
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${model.enabled_for_monitoring ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'}
                      `}
                    >
                      <span
                        className={`
      ...
      <section className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Recent Uptime History</h2>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
              >
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
              {filteredHistory.map((check) => (
                <tr key={check.id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`
                      ...
                      ${check.status === 'up' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 
                        check.status === 'down' ? 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300' : 
                  ...
                  <td className="px-6 py-4 text-sm text-red-600 dark:text-red-400 max-w-xs truncate" title={check.error || ''}>
                    {check.error || '-'}
                  </td>
                </tr>
              ))}
